			...
			if (requirements) {
				...
				if (requirements.sector) {
					if (action == "scavenge") {
						...
						if (!hasScavengeableResources && !hasScavengeableItems) {
							return { value: 0, reason: "There are no resources to scavenge here.", baseReason: PlayerActionConstants.DISABLED_REASON_INVALID_SECTOR };
						}
					}
